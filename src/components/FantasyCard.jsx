...
export default function FantasyCard({
  ...
  return (
    ...
    <>
    <div id={deteccion} className="relative flex flex-col bg-gray-400 bg-opacity-30 border-2 border-white mb-6 rounded-lg bg-grey-700 justify-center shadow-lg md:flex-col items-center gap-4 w-2/5 p-4 transition-all duration-300 ease-in-out hover:bg-opacity-80 hover:-translate-y-5 md:shadow-lg">
    <div className="player-delete" onClick={onRemove}>x</div>
